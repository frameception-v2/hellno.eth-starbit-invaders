...
### User Prompt
build a game of space invaders that is entertaining to use on a mobile screen. retro vibes. Adjust template to have maximum screen size of the game. Show score at the top
